...
{
    system("CLS");
    cout<<"自制在线代码评测系统 ver-1.0 (创建比赛)"<<endl<<endl;
...
void My_contests(int user_id)                                   // 查看自己创建的比赛
{
    ...
    {
        system("CLS");
        cout<<"自制在线代码评测系统 ver-1.0 (我的比赛) "<<endl;
        cout<<"1.进入比赛    2.返回"<<endl<<endl;
...
{
    system("CLS");
    cout<<"自制在线代码评测系统 ver-1.0 (排名页) "<<endl;
...
{
    system("CLS");
    cout<<"自制在线代码评测系统 ver-1.0 (实时评测页) "<<endl;
...
void IC_submit_code(int contest_id,int ICP_id,int user_id)      // 提交代码
{
    ...
    cout<<"自制在线代码评测系统 ver-1.0 (评测结果) "<<endl<<endl;
